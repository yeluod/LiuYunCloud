 ...
 **/
@Slf4j
public class PhoneSmsAuthenticationProvider extends BaseAuthenticationProvider<PhoneSmsAuthenticationToken> {

    public PhoneSmsAuthenticationProvider(AuthenticationManager authenticationManager,
    ...
    public boolean supports(Class<?> authentication) {
        boolean supports = PhoneSmsAuthenticationToken.class.isAssignableFrom(authentication);
    ...
    protected UsernamePasswordAuthenticationToken buildToken(Map<String, Object> reqParameters) {
        ...
        String password = (String) reqParameters.get(AuthServerConstant.PARAMETER_PHONE_CODE);
